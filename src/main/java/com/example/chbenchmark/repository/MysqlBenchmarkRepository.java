...
@Repository
public class MysqlBenchmarkRepository implements BenchmarkRepository {

    private final JdbcTemplate jdbcTemplate;

    public MysqlBenchmarkRepository(@Qualifier("mysqlJdbcTemplate") JdbcTemplate jdbcTemplate) {
    ...
    public CountResult countByDays(int days) {
        ...
        Long result = jdbcTemplate.queryForObject(
            "SELECT COUNT(*) FROM events WHERE event_time >= ?", Long.class, Timestamp.valueOf(from));
